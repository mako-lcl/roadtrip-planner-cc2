...
fun SegmentedControl(
    ...
    val bike = painterResource(id = R.drawable.ic_bike)
    val bicycle = painterResource(id = R.drawable.ic_bicycle)
    val walk = painterResource(id = R.drawable.ic_walk)
            ...
            OutlinedButton(
                ...
                when (item) {
                    TransportationType.CAR -> {
                        Icon(painter = car, contentDescription = null, tint = Color.Black)
                    }
                    TransportationType.BIKE -> {
                        Icon(painter = bike, contentDescription = null, tint = Color.Black)
                    }
                    TransportationType.BICYCLE -> {
                        Icon(painter = bicycle, contentDescription = null, tint = Color.Black)
                    }
                    else -> {
                        Icon(painter = walk, contentDescription = null, tint = Color.Black)
                    }
                }
            }
        }
